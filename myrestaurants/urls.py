...
urlpatterns = patterns('',
    ...
    url(r'^restaurants/(?P<pk>\d+)/$', #myrestaurants/pk=1/ si posem el pk, si nomes posem el d+ myrestaurants/1/. Posar nom ens pot servir per a un futur fer distincions
